...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <select name="method" class="box" required id="modeofpay">
      ...
      <button onClick="pay()" class="btn">Make Payment</button>
      <input type="submit" value="place order" class="btn <?php if($fetch_profile['address'] == ''){echo 'enable';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit">
   </div>
...
function pay(){
    ...
    console.log("hii")
    var paymentMethod = document.getElementById("modeofpay").value;
        console.log(paymentMethod);
   if(paymentMethod=="credit card"||paymentMethod=="paypal"||paymentMethod=="paytm")
   {
